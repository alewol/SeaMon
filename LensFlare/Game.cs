...
namespace LensFlare
{
    ...
    public class LensFlareGame : Microsoft.Xna.Framework.Game
    {
        ...
        protected override void LoadContent()
        {
            ...
            sceneDepth = new RenderTarget2D(GraphicsDevice, width, height, true, SurfaceFormat.Single, DepthFormat.Depth24);

            waterReflection = new RenderTarget2D(GraphicsDevice, width, height, true, SurfaceFormat.Color, DepthFormat.Depth24);
            sceneColor = new RenderTarget2D(GraphicsDevice, width / 2, height / 2, true, SurfaceFormat.Color, DepthFormat.Depth24);
        ...
        private void DrawReflection(float aspectRatio, out Matrix reflectionViewProjection)
        {
            ...
            GraphicsDevice.SetRenderTarget(this.waterReflection);
        ...
        protected override void Draw(GameTime gameTime)
        {
            ...
            GraphicsDevice.SetRenderTarget(this.sceneColor);
            GraphicsDevice.Clear(ClearOptions.DepthBuffer | ClearOptions.Target, Color.CornflowerBlue, 1f, 0);
            ...
            GraphicsDevice.SetRenderTarget(this.sceneDepth);
            ...
            this.water.Draw(graphics.GraphicsDevice, this.sceneDepth, this.waterReflection,
                            this.sceneColor, reflectionViewProjection, view, projection, (float)gameTime.TotalGameTime.TotalSeconds,
