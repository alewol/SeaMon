...
namespace LensFlare
{
    ...
    public class LensFlareComponent : DrawableGameComponent
    {
        ...
        public Vector3 LightDirection = Vector3.Normalize(new Vector3(0.9f, -0.05f, 0.3f));
        ...
        VertexPositionColorNormal[] queryVertices;
        ...
        protected override void LoadContent()
        {
            ...
            queryVertices = new VertexPositionColorNormal[4];
